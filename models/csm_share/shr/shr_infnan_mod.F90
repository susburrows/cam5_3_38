...
integer(i4), parameter :: sneginf_pat = int(Z'FF800000',i4)
! Double precision.
...
integer(i8), parameter :: dneginf_pat = int(Z'FFF0000000000000',i8)
#endif
